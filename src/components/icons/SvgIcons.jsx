...
export const SampleIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const ArrowInIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3v12" />
...
export const ArrowOutIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 15V3" />
    <path d="m8 7 4-4 4 4" />
    <path d="M4 21h16" />
...
export default {
  BoxIcon, WalletIcon, UsersIcon, WrenchIcon, SampleIcon, ScissorsIcon,
  PlusIcon, TrashIcon, EditIcon, CheckIcon, ClockIcon, BellIcon,
  ArrowInIcon, ArrowOutIcon, ShieldIcon, PhoneIcon, WhatsAppIcon
};
